...
- handoff 1: .qq/handoffs/1-brief.md via agent send + pane send-keys Enter. Lesson: ~2s delay needed between send and Enter (first Enter landed before the text; resent).
